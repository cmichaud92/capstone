...
###################################################################
#                 Seining Project Database loading                #
###################################################################
...
# Fetch config for SE project
config <- config::get(value = "SEcap_config",
                      file = "./config.yml")
...
saveRDS(fnl_dat, file = paste0(config$root_path,"output/final-data.Rds"))
